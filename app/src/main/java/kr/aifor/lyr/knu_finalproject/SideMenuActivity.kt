...
class SideMenuActivity : AppCompatActivity() {
    ...
    lateinit var rec_side: RecyclerView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rec_side = findViewById(R.id.easy_side_recyclerview)
        rec_orderList = findViewById(R.id.easy_orderList_side)
        completeButton = findViewById(R.id.side_complete_btn)
        cancleButton = findViewById(R.id.side_cancle_btn)
        ...
        menuAdapter = MenuAdapterEasy(menuList.sideList, fireBaseData)
...
/*        val cancelButton = findViewById<Button>(R.id.side_cancle_btn)
